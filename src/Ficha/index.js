      ...
      {car.name ? (
        <div>
          ...
          <div className="firstBlock1">
            ...
            <img src={"http://challenge.agenciaego.tech" +car["model_highlights"][0].image} className="layer" alt="img"></img>
          </div>

          <div className="firstBlock">
            <img
              src={"http://challenge.agenciaego.tech" +car["model_highlights"][1].image}
              className="layer"
              alt="img"
            ></img>
            <div className="titleContent1">
